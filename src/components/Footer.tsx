      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-200">
          <div className="flex space-x-4 mb-4 md:mb-0">
            ...
            <a className="p-2 bg-black text-white rounded-full" href="https://www.instagram.com/hermarkpress?igsh=ejR5NG9wYTlqeHdu" target="_blank" rel="noopener noreferrer">
              <Instagram size={20} />
            </a>
            <a className="p-2 bg-black text-white rounded-full" href="https://www.linkedin.com/company/hermark-press/" target="_blank" rel="noopener noreferrer">
              <Linkedin size={20} />
            </a>
          </div>
